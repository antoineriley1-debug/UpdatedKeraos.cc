...
// =============================================================
// Path: app/api/smartsheet/tasks/route.js
// =============================================================

const DEFAULT_SHEET_ID_FALLBACK = "8870685098069892";
...
export async function GET(req) {
  ...
  try {
    ...
    const tasks = (sheet.rows || []).map((row) => {
      const obj = {
        id: row.id,
